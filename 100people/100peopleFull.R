...
kentucky <- read.csv("ss14pky.csv")
indiana  <- read.csv("ss14pin.csv")
naicsNames <- read.csv("naicsNames.csv")


#PUMA's to approximate Louisville MSA
...
kentucky <- pumaFilter(kyPuma, kentucky)
indiana  <- pumaFilter(inPuma, indiana)



##Combine data sets
workforce <- rbind(kentucky, indiana)
workforce <- merge(workforce, naicsNames, by="NAICSP" )
#dd <- is.na(workforce)
...
#Add Foreign Born
#Add People who haven't worked in the last 5 years
#Easily accessible by Public Transportation
#Intentially Recruit More Women
#Raise entry-level wages to 35k
