...
healthcareOccupations <- read.csv("../../rData/healthcareOccupationsData/healthOccupationsData.csv")
jobPostings           <- read.csv("../../rData/healthcareOccupationsData/jobPostings.csv")
